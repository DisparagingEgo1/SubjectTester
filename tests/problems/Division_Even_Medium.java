...
public class Division_Even_Medium extends Problem {

	public Division_Even_Medium() {
		super();
		Random rand = new Random();
		int num1 = rand.nextInt(71)+2;
		int num2 = rand.nextInt(5)+2;
		while(num1%num2 != 0) {
			num1 = rand.nextInt(71)+2;
